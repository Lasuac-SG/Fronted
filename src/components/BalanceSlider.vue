<template>
  ...
  >
    ...
    <div
      aria-hidden="true"
      :class="cn('slider-value-labels pointer-events-none absolute inset-x-0 top-0 z-[2] h-1/2 text-base')"
...
const sliderLabelStyles = computed(() => ({
  "--shift": shift.value,
  "--leftValue": value.value,      // 左侧实际数值
  "--rightValue": props.max,       // 右侧最大余额
}));
